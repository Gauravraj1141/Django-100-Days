    ...
    if not request.user.is_authenticated:
        if request.method == "POST":
            ...
            if formdata.is_valid():
                ...
                # here we give all new users this group permission means when user register then user will automatically add in viewwers group and we can manage all permissions to the viewers group
